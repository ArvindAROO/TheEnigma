# -*- coding: utf-8 -*-
"""
Created on Mon Apr 27 15:12:06 2020
...
class Enigma():
    """The class of Enigma. The famous Machine from worldwar-II"""
    ...
    def MonoSubsEncrypt(self, char, array):
        """This functions substitutes each char passed to the function
    ...
    def RotorMainEncrypt(self, string):
        ...
        first_rounds += 1
        #The first rotor will rotate once for every character
...
def StringHandling(string, array1, array2, array3, encrypt = True):
    ...
    using the appropriate methods of parsing and passing the arguments to 
    ...
    if encrypt:
        ...
        for i in string:
            if i.isupper():
                ...
                #non-alphabets are not encrypted
                res+= i
        del En
...
def main():
    try:
        ...
        if(flag.lower() == 'yes' or flag.lower() == 'y' or flag.lower() == 's'):
            ...
            ar1 = ('a', 'b', 'u', 'h', 'm', 't', 'g', 'o', 'x', 'n', 'v', 'p', 'd', 'w', 'z', 'r', 'f', 'e', 'j', 's', 'y', 'c', 'l', 'q', 'k', 'i')
            ar2 = ('s', 'j', 'v', 'h', 'i', 'e', 'g', 'x', 'f', 'u', 'n', 'r', 'k', 'a', 'b', 'z', 'q', 't', 'w', 'm', 'c', 'o', 'l', 'd', 'p', 'y')
            ar3 = ('d', 'k', 'n', 'r', 'i', 'j', 'b', 'z', 'c', 'v', 'm', 'p', 's', 'l', 't', 'g', 'f', 'w', 'x', 'h', 'o', 'u', 'e', 'q', 'a', 'y')
        
        E = input("Press 'e' for encryption\nPress 'd' for decryption: ")
        string = input("\nEnter the string : ")
        if (E.lower() == 'e'):
